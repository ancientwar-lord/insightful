...
export default function RefreshKeywordBanner({ keyword }: { keyword: string }) {
        ...
        <div className="flex w-full sm:w-auto items-center gap-3">
          <div className="relative flex-1 sm:w-48">
            <input
              ...
              value={keyword}
              disabled
              className="w-full h-11 pl-4 pr-4 rounded-xl border border-zinc-300 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-800 text-sm focus:outline-none transition-all disabled:opacity-70 cursor-not-allowed text-zinc-500 dark:text-zinc-400"
            />
          </div>
          <button
